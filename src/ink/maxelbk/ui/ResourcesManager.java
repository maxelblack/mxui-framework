...
public class ResourcesManager {
    ...
    public static Color putColor(String key, Color color) {
    	return (Color) global.put("colors." + key, color);
    }
    public static Color getColor(String key) {
    	return (Color) global.get("colors." + key);
	}
	public static String putString(String key, String string) {
    	return (String) global.put(key, string);
	}
